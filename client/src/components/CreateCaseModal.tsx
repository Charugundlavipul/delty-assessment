...
import { X, FileText, Upload, Stethoscope, Calendar, Activity, AlertCircle } from 'lucide-react'
...
export default function CreateCaseModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Active case created')
            onSuccess()
            onClose()
        } catch (error) {
            console.error(error)
                                    ...
                                    <div className="px-6 py-6 space-y-6">
                                        ...
                                        <div className="group">
                                            ...
                                            <div className="relative">
                                                <select
                                                    className="block w-full rounded-xl border-slate-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-slate-900 py-3 bg-slate-50 focus:bg-white transition-colors"
                                                ...
                                                {!formData.patient_id && (
                                                    <div className="absolute right-10 top-3 text-amber-500 pointer-events-none">
